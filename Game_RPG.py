...
hero1 = Hero("siwit", 100, 15)
hero2 = Hero("kaji tubles", 120, 20)
...
eudora = Mage("siwit", 80, 30, 100)
balmond = Hero("kaji tubles", 200, 10)
...
pasukan = [
    Mage("siwit", 90, 25, 60),
    Archer("kaji tubles", 100, 20),
    Fighter("ambatron", 150, 30),
    Mage("bigmo", 70, 35, 80)
]
